<div>
    <x-alert />
    <form class="row g-3" method="POST" action="{{ route('optionStructures.store') }}" style="width: 1200px;">
        @csrf
        <div class="col-md-6" style="margin-bottom: 35px">
            <x-forms.input label="Option Name" name="optionName" placeholder="Option Name" />
        </div>
        <div class="card-body">
            <div class="col-md-6" style="margin-bottom: 35px">

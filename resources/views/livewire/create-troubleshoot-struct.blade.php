<div>
    <x-alert />
    <form class="row g-3" method="POST" action="{{ route('troubleshoots.store') }}" style="width: 1200px;">
        @csrf
        <div class="col-md-6" style="margin-bottom: 35px">
            <x-forms.input label="Troubleshoot Name" name="troubleshootName" placeholder="Troubleshoot Name" />
        </div>
        <div class="card-body">
            <div class="col-md-6" style="margin-bottom: 35px">

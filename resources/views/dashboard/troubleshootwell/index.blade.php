                    ...
                    <tbody>
                        @foreach ($wells as $well)
                            <tr>
                                ...
                                <td class="btn-group">
                                    <a href="{{ route('troubleshootwells.delete',$well->id) }}" class="btn btn-sm btn-outline-danger">delete</a>
                                    <a href="{{ route('export.troubleshoot',$well->id) }}"

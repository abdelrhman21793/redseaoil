...
<body>
    @foreach ($surveys as $survey)
        ...
        <div class=" structure_desciption">
            @foreach ($survey->survey_structures as $structure)
            <h3 class="structureName text-center mb-0 mt-2"><b>{{ $structure->name }}</b></h3>
            <div class="grid">
                @foreach ($structure->survey_structure_descriptions as $struct_desc)
                    @if ($struct_desc->type=='String' || $struct_desc->type=='Int' || $struct_desc->type=='User' || $struct_desc->type=='Boolean' || $struct_desc->type=='Date' || $struct_desc->type=='List'|| $struct_desc->type=='date_desc')
                        <div class="tableRows">
